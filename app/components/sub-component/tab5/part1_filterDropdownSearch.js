        ...
        >
            <div className="grid grid-cols-12 gap-6 my-2">
                <div className="col-span-12 lg:col-span-12 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    >
                        <div className="grid grid-cols-4 gap-4 items-center px-4 transition-all duration-500 group-hover:blur-lg group-hover:bg-gray-50/50">
                            <div className="flex-1 flex flex-col justify-center p-4 bg-gray-50 rounded-xl border-l-4 border-emerald-500 my-2 shadow-xs">
                                ...
                                <div className="items-baseline gap-2 text-right">
                                    <span className="text-xl font-bold text-gray-600">
                                        {part5ForShow[details?.regionId]?.pro_main_name || "-"}
                                    </span>
                                </div>
                            </div>
                            <div className="flex-1 flex flex-col justify-center p-4 bg-gray-50 rounded-xl border-l-4 border-emerald-500 my-2 shadow-xs">
                                ...
                                <div className="items-baseline gap-2 text-right">
                                    <span className="text-xl font-bold text-gray-600">
                                        {
                                            part5ForShow[details?.regionId]?.pro_sub[details?.areaId]?.pro_sub_id
                                            ? "เขต" +  part5ForShow[details?.regionId]?.pro_sub[details?.areaId]?.pro_sub_id
                                            : "-"
                                        }
                                    </span>
                                </div>
                        ...
                        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 translate-y-10 group-hover:translate-y-0 transition-all duration-500 ease-out">
                            <div className="flex items-center gap-1 text-xl font-bold text-gray-600">
