        ...
        >
            <div className="grid grid-cols-12 gap-6 my-2">
                <div className="col-span-12 lg:col-span-12 bg-white lg:p-6 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    >
                        <div className="grid lg:grid-cols-10 lg:gap-4 items-center px-4 transition-all duration-500 group-hover:blur-lg group-hover:bg-gray-50/50">
                            <div className="col-span-12 lg:col-span-2 flex flex-col justify-center p-4 bg-gray-50 rounded-xl border-l-4 border-emerald-500 my-2 shadow-xs">
                            ...
                            <div className="col-span-12 lg:col-span-4 flex flex-col justify-center p-4 bg-gray-50 rounded-xl border-l-4 border-emerald-500 my-2 shadow-xs">
