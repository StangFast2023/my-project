        ...
        <div>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="col-span-12 lg:col-span-12">
                    <div className="grid grid-cols-1 grid-cols-2 gap-2 md:grid-cols-4 lg:grid-cols-4 lg:gap-4">
                        {[...Array(4)].map((_, i) => (
                ...
                <div className="animate-pulse col-span-12 lg:col-span-6 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                    <div>
                ...
                {[...Array(2)].map((_, i) => (
                    <div key={i} className="animate-pulse col-span-12 lg:col-span-12 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        <div>
                            <h3 className="flex text-sm md:text-base lg:text-lg font-bold mb-6 text-gray-700">
                                <span className="ml-2 text-white">-</span>
                            </h3>
                ...
                {[...Array(4)].map((_, i) => (
                    <div key={i} className="animate-pulse col-span-12 lg:col-span-6 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        <div>
                            <h3 className="flex text-sm md:text-base lg:text-lg font-bold mb-6 text-gray-700">
                                <span className="ml-2 text-white">-</span>
                            </h3>
